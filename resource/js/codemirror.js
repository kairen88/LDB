...
window.CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    var instance = wrapper.CodeMirror = {
      ...
      reduceWindowSize:operation(reduceWindowSize),
      normalWindowSize:operation(normalWindowSize),
      highlightGutters:operation(highlightGutters),
    ...
    function reduceWindowSize() {
	    $('.CodeMirror').removeClass('CodeMirror').addClass('CodeMirror-reduce');
    }
    function normalWindowSize() {
	    $('.CodeMirror-reduce').removeClass('CodeMirror-reduce').addClass('CodeMirror');
    }

    function highlightGutters(lineNum) {

		var index=1;
	
//	$('.CodeMirror-gutter').each(function(i, obj) {


		//if(index==2){
		//	$(this).removeClass('CodeMirror-gutter').addClass('CodeMirror-gutter-highlight');			
		//}
          //         index++;
	
	//});
	/*	var divs=$('.CodeMirror-gutter');		
		for(var i=0;i<divs.length;i++){
			if(i<4)	{		
				var  div = divs[i];
				$(div).removeClass('CodeMirror-gutter').addClass('CodeMirror-gutter-highlight');			
			}
			index++;
...
*/
	 ...
	 $( ".CodeMirror-gutter-text" ).each(function ( index, domEle) {
		// domEle == this
		//$( domEle ).css( "backgroundColor", "yellow" );
		if ( index==2){//$(this).is( "#stop" ) ) {
			$(domEle).removeClass('CodeMirror-gutter-text').addClass('CodeMirror-gutter-text-highlight');
		//	alert(index);
		//	return false;
		}
	});
